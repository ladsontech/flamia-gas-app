...
const ImageCarousel: React.FC = () => {
  ...
  return (
    <div className="relative w-full overflow-hidden rounded-lg shadow-sm mb-3">
      <div className="aspect-[3/1.5] sm:aspect-[3/1.2] md:aspect-[3/1]"> {/* Adjusted aspect ratio for better responsiveness */}
        {loading && (
        ...
        <AnimatePresence mode="wait">
          ...
          >
            ...
            <AspectRatio ratio={3/1.5} className="sm:aspect-[3/1.2] md:aspect-[3/1]">
              <img
            ...
            <div className="absolute bottom-0 left-0 right-0 p-2 sm:p-3 text-white z-20">
      ...
      <button 
        onClick={prevSlide}
        className="absolute left-1 top-1/2 transform -translate-y-1/2 z-30 hidden sm:flex items-center justify-center w-7 h-7 rounded-full bg-white/70 hover:bg-white/90 text-accent"
      ...
      <button 
        onClick={nextSlide}
        className="absolute right-1 top-1/2 transform -translate-y-1/2 z-30 hidden sm:flex items-center justify-center w-7 h-7 rounded-full bg-white/70 hover:bg-white/90 text-accent"
